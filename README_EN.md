...
The current source tree uses deployment contract `agents_version: 32`. Rerun `/story-setup` after upgrading; multi-agent configuration takes effect in a new session. Contracts for published versions are listed in the release summaries below.
