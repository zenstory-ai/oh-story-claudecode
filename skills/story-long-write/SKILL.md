...
**规划续接**：保留当前任务范围；"继续/继续写/按这个来/确认方案"不扩大范围，完成即停，不自动转细纲或正文。新明确请求可调整规划层级/范围；不把规划模式写入追踪或作者记忆，不调用 narrative-writer，委派传同一范围和停点。
...
**正文匹配**：已明确要正文时，按 大修 → 写指定章 → 日更续写 匹配。日更前置不齐则提示补齐或写第1章，不直接写一批。
