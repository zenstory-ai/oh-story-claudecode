...
| 处置 | 判据 | 出口 |
|---|---|---|
| **登记** | 无 S1/S2；不需要在卷纲占 F/L 编号或新增反转/打脸债行；不碰主推线与终局底牌边界，不与活跃伏笔、下一章承诺打架 | 进步骤 12 的事务：角色/势力按 workflow-setup Phase 3 补建静态档案；可复用设定补进 `设定/世界观/{主题}.md`；伏笔、关系、约束、下章承诺进对应 delta 字段 |
