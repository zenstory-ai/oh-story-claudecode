...
- 本书自定义文风或主对标原文即时提炼的临时文风只管句长、标点、潜台词、锚点片段和笔调；它不覆盖题材卡，也不覆盖 `全局分析/爆款机制.md` / `全局分析/六维拆书.md` 的“三维节奏”章节。
...
1. 同题材对标书的 `全局分析/爆款机制.md` 与 `全局分析/六维拆书.md` 的“三维节奏”章节。
2. `设定/文风.md`，或主对标 `chapter_index.csv` 命中章的 `source_locator` 原文，确认句长、声线和段落节奏。
