...
- [ ] 伏笔有推进
- [ ] 故事引擎还在运转
- [ ] 对照本章批准细纲核对新增物：闲话、即时反应和服务既有情节点的微连接不算；写了要报：本章写出的新关系、承诺、后续义务要在申报表里列出，由主会话处置；只有与细纲或已登记事实冲突的才是必须修
...
| 章节字数偏离目标 | medium（长篇欠字交作者定） | 先核对情节点是否都写到；都写到就不为字数加戏，超字最多净删一次；去AI味已有正文时不得新增剧情 |
