...
| 拆书方法论 | Stage 1、3-6（三章+结构块+全局）| 拆解视角和提取方法 |
| 结构设计与节奏 | Stage 3-4（结构块+三维节奏）| 结构块边界、节奏地图和情绪曲线构建 |
| 卖点循环设计 | Stage 5（爆款机制）| 爽点循环模式识别 |
| 桥段词表 | Stage 3-5 | 辅助命名结构块与机制，不生成逐章桥段卡 |
| 经典作品拆解 | Stage 1、3-6 | 对标拆解参考框架 |
| 拆书实操技巧 | Stage 3-4（结构块+三维节奏）| 情绪折线图、期待分析 |
| 对标书选择 | Stage 0（概要提取）| 确定拆解对象 |
| 抽象拆书法 | Stage 3-4 | 三幕式结构归纳 |
| 影视拉片与情绪控制 | Stage 3-4 | 情绪曲线精细化分析 |
| 多线叙事与结构循环 | Stage 3-4 | 多线交织识别 |
| 题材实战 | Stage 0-1（概要+三章）| 题材特有爽点形态 |
| 人设塑造 | Stage 5（人物关系图）| 角色动力与关系动作分析 |
| 素材转化 | 拆文完成后的独立灵感抽象 | 只向 `/story-inspiration-distill` 提供方法参考 |
