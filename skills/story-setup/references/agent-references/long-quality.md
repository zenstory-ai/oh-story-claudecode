...
- [ ] ①主角靠自己的选择挣到结果：保有因果权与结算权；配角可以执行局部动作，但不能无声夺走关键选择和结算。
- [ ] ②核心卖点按开篇承诺兑现，收益和高光没有被配角、机构或巧合无交换地拿走。
- [ ] ③本卷没有动用后续阶段才该解锁的宿敌、身份、真相或能力上限，升级线没有顶到天花板。
- [ ] ④延期的期待支付了利息，而不是被流程、解释或新设定吞掉；旧期待回收时留下新期待。
- [ ] 高潮后允许短暂低压和可见奖励，不机械立即追加更大危机。

四问都过＝契约安全；能靠补交换、铺垫或成本补上＝需补强；补不上＝契约破坏，先修纲再写。
