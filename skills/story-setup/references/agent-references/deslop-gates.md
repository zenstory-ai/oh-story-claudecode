...
3. 删除服从过度去AI味保护：不整段删、不删剧情功能；删除比例上限按 AI 味等级，轻度 ≤15%，中度 ≤25%，重度 ≤35%；若删后跌破本次字数范围的下沿，改为降AI重写，不删完再用新废话凑字。
...
以下为各 Gate 的详细规则（删不掉的标记项按此润色；无论 agent 还是主会话执行，均须遵循）：
...
- 用动作/场景收尾，不要用感慨收尾
- 如果结尾有"他知道...""这一刻..."→ 基本可以删
- 短篇（单个 正文.md）带主角主观情绪的审判句、火葬场预告、心死式章尾是卖点，保留；只删中立、与角色情绪无关的作者讲解。
...
- **F 结尾去升华**：大段抒情收尾→安静细节收尾；短篇例外见门禁 F。
- **G 去解释腔/上帝感**：先按本书叙述姿态判断，短篇例外见门禁 G；授权的有限全知、评论或旁人内心不因形式删除。删无功能的解释、未经授权的剧透、重复总结和空泛定性（之所以/原来/这意味着/她不知道的是/殊不知/多年以后）；承担锚点或情绪的压成角色白话；已有场内载体（手机/公告/屏幕）优先保留为角色看到的文本。
